package me.rto.beerstock;

import me.rto.beerstock.builder.BeerDTOBuilder;
import me.rto.beerstock.controller.BeerController;
import me.rto.beerstock.dto.BeerDTO;
import me.rto.beerstock.dto.QuantityDTO;
import me.rto.beerstock.exceptions.BeerNotFoundException;
import me.rto.beerstock.service.BeerService;
...
import static me.rto.beerstock.utils.JsonConvertionUtils.asJsonString;
    ...
    void whenPostIsCalledThenBeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
            ...
            .content(asJsonString(beerDTO)))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.name", Is.is(beerDTO.getName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.brand", Is.is(beerDTO.getBrand())))
